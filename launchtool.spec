...
launchtool jest narzędziem, które uruchamia podane polecenie i może
nadzorować jego wykonywanie na wiele sposobów, takich jak kontrola
jego środowiska, blokowanie sygnałów, logowanie wyjścia, zmiana
uprawnień użytkownika i grupy, ograniczanie użycia zasobów, restart w
